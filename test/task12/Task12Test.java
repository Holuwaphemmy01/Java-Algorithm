...
class Task12Test {
    ...
    public void tests() {
        ...
        assertEquals("found the needle at position 3", Task12.findNeedle(haystack1));
        assertEquals("found the needle at position 5", Task12.findNeedle(haystack2));
        assertEquals("found the needle at position 30", Task12.findNeedle(haystack3));
        assertEquals("found the needle at position 5", Task12.findNeedle(haystack4));
    }

    @Test
    public void doNotCompareStringsWithEqualOperator() {
        Object[] haystack = { "junk", "more junk", new String("needle"), "gadget" };
        assertEquals("found the needle at position 2", Task12.findNeedle(haystack));
    }
